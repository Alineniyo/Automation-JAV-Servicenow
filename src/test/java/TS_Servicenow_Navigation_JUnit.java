...
public class TS_Servicenow_Navigation_JUnit {
    ...
    public TS_Servicenow_Navigation_JUnit() {
        // Default constructor
    }
    ...
    FW_CustomAssertJU.autoPass(po_Home.clickAcceptTerms());
    FW_CustomAssertJU.autoPass(po_Home.validateOnPage());
    FW_CustomAssertJU.autoPass(po_Home.validateSearch());
    FW_CustomAssertJU.autoPass(po_Home.validateRegion());
    FW_CustomAssertJU.autoPass(po_Home.validateSignIn());
    FW_CustomAssertJU.autoPass(po_Home.validateProductsDropDown());
    FW_CustomAssertJU.autoPass(po_Home.validatePlatformDropDown());
    FW_CustomAssertJU.autoPass(po_Home.validatePartnersDropDown());
    FW_CustomAssertJU.autoPass(po_Home.validateResourcesDropDown());
    FW_CustomAssertJU.autoPass(po_Home.validateCompanyDropDown());
    FW_CustomAssertJU.autoPass(po_Home.validateGetStartedDropDown());
